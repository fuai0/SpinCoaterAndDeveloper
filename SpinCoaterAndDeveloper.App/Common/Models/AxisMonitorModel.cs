...
{
    public class AxisMonitorModel : BindableBase
    {
        private int _Id;
        public int Id
        {
        ...
        private double _RelMoveDistance;
        public double RelMoveDistance
        {
            get { return _RelMoveDistance; }
            set { SetProperty(ref _RelMoveDistance, value); }
        }
        private double _ReciprocateStartPoint = 0;
        public double ReciprocateStartPoint
        {
            get { return _ReciprocateStartPoint; }
            set { SetProperty(ref _ReciprocateStartPoint, value); }
        }

        private double _ReciprocateEndPoint = 0;
        public double ReciprocateEndPoint
        {
            get { return _ReciprocateEndPoint; }
            set { SetProperty(ref _ReciprocateEndPoint, value); }
        }
        private double _ReciprocatePauseTime = 0;
        public double ReciprocatePauseTime
        {
            get { return _ReciprocatePauseTime; }
            set { SetProperty(ref _ReciprocatePauseTime, value); }
        }
        //轴状态
        private int _Status;
        public int Status
        ...
        {
            get { return _PrfPos; }
            set { SetProperty(ref _PrfPos, value); }
        }
        private double _PrfVel;
        public double PrfVel
        {
            get { return _PrfVel; }
            set { SetProperty(ref _PrfVel, value); }
        }
        private double _EncPos;
        public double EncPos
        {
            get { return _EncPos; }
            set { SetProperty(ref _EncPos, value); }
        }
