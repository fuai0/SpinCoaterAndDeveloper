...
namespace TemperatureControllerService.Service
{
    ...
    {
        private ServiceTemperatureControllerConfigurationStore Store { get; set; }
        public TemperatureControllerConfig()
        {
            Store = new ServiceTemperatureControllerConfigurationStore();
        }

        public ServiceTemperatureControllerConfigurationSection LoadConfigFromFile()
        {
            ServiceTemperatureControllerConfigurationSection section = Store.RetrieveServicesTemperatureControllerConfigurationSection();
            return section == null ? null : section;
        }
    }

    public class ServiceTemperatureControllerConfigurationStore
    {
        private Configuration config;
        public ServiceTemperatureControllerConfigurationSection RetrieveServicesTemperatureControllerConfigurationSection()
        {
            ExeConfigurationFileMap exeMap = new ExeConfigurationFileMap() { ExeConfigFilename = "TemperatureControllerService.config" };
            config = ConfigurationManager.OpenMappedExeConfiguration(exeMap, ConfigurationUserLevel.None);

            return config.GetSection("TemperatureControllerConfigGroup") as ServiceTemperatureControllerConfigurationSection;
        }
        ...
        {
            ServiceTemperatureControllerConfigurationSection section = this.RetrieveServicesTemperatureControllerConfigurationSection();
    ...
    public class ServiceTemperatureControllerConfigurationSection : ConfigurationSection
    {
    ...
    public class ServiceConfigurationElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return "TemperatureControllerConfig"; }
        }
